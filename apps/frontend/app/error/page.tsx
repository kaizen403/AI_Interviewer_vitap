 ...
 * - expired: Review link has expired
...
const ERROR_CONFIG: Record<string, {
  ...
  invalid: {
    icon: 'warning',
    title: 'Invalid Link',
    description: 'This review session link is invalid or has expired. Please check your email for the correct link.',
  },
  cancelled: {
    icon: 'cancelled',
    title: 'Review Cancelled',
    description: 'This review session has been cancelled. If you believe this is an error, please contact support.',
  },
  expired: {
    icon: 'expired',
    title: 'Link Expired',
    description: 'This review session link has expired. Please request a new link.',
  },
  network: {
    icon: 'error',
